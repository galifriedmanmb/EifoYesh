...
public class FavoritesListAdapter extends RecyclerView.Adapter<FavoritesListAdapter.PlaceViewHolder> {

    Context c;
    FragmentChanger fragmentChanger;
    Location currentLocation;
    ArrayList<FavoritePlace> allPlaces;
    int type;

    //public SearchListAdapter(ArrayList<ResultItem> allResults, Context c, FragmnetChanger fragmnetChanger) {
    public FavoritesListAdapter(Context c, FragmentChanger fragmentChanger, Location currentLocation, ArrayList<FavoritePlace> allPlaces) {
        this.c = c;
    ...
    public FavoritesListAdapter.PlaceViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    public void onBindViewHolder(FavoritesListAdapter.PlaceViewHolder holder, int position) {
        holder.itemView.setLongClickable(true);
        FavoritePlace resultItem = allPlaces.get(position);
        ...
        class PlaceViewHolder extends RecyclerView.ViewHolder {
            ...
            public void bindData (final FavoritePlace resultItem) {
